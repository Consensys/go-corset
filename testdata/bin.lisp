...
(column bin:ARGUMENT_1_LO)
(column bin:ACC_5)
(column bin:PIVOT :u8)
(column bin:ARGUMENT_1_HI)
(column bin:SMALL :u1)
(column bin:IS_OR :u1)
...
(column bin:BITS :u1)
(column bin:BIT_1 :u1)
(column bin:ARGUMENT_2_LO)
(column bin:IS_BYTE :u1)
(column bin:ACC_4)
(column bin:ONE_LINE_INSTRUCTION :u1)
(column bin:COUNTER :u8)
(column bin:ACC_2)
(column bin:RESULT_HI)
(column bin:NEG :u1)
(column bin:BYTE_2 :u8)
(column bin:INST :u8)
(column bin:ARGUMENT_2_HI)
