...
func (p *Assignment) String(env sc.RegisterLimbsMap) string {
...
func (p *Assignment) Width(env sc.RegisterLimbsMap) uint {
	var (
		// Determine lhs width
...
func (p *Assignment) Overflow(env sc.RegisterLimbsMap) (uint, uint) {
	var (
		// Determine lhs width
		lhs = CombinedWidthOfLimbs(env, p.LeftHandSide...)
		// Determine rhs width
...
func identifyEnclosingRegister(regs []sc.RegisterId, value big.Int, env sc.RegisterLimbsMap) (uint, uint) {
	var bitOffset uint
	//
