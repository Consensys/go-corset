...
func (p *Assignment) String(env sc.ModuleRegisterMap) string {
...
func (p *Assignment) Width(env sc.ModuleRegisterMap) uint {
	var (
		// Determine lhs width
...
func (p *Assignment) Overflow(env sc.ModuleRegisterMap) (uint, uint) {
	var (
		// Determine lhs width
		lhs = CombinedWidthOfLimbs(env, p.LeftHandSide...)
		// Determine rhs width
...
func (p *Assignment) Terminate(env sc.ModuleRegisterMap) (Assignment, Polynomial) {
	var (
		tmp Polynomial
		// Determine lhs width
		lhs = CombinedWidthOfLimbs(env, p.LeftHandSide...)
...
func (p *Assignment) initialiseSplit(env sc.ModuleRegisterMap) []Assignment {
	var (
...
func identifyEnclosingRegister(regs []sc.RegisterId, value big.Int, env sc.ModuleRegisterMap) (uint, uint) {
	var bitOffset uint
	//
