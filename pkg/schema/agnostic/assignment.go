...
func (p *Assignment) String(env register.Map) string {
	...
	//
	builder.WriteString(" := ")
	builder.WriteString(poly.String(p.RightHandSide, func(id register.Id) string {
...
func (p *Assignment) Overflow(env register.Map) (uint, uint) {
	var (
		// Determine lhs width
		lhs = CombinedWidthOfRegisters(env, p.LeftHandSide...)
		// Determine rhs width
...
func (p *Assignment) Terminate(env register.Map) (Assignment, StaticPolynomial) {
	var (
...
func (p *Assignment) initialiseSplit(env register.Map) []Assignment {
	var (
...
func identifyEnclosingRegister(regs []register.Id, value big.Int, env register.Map) (uint, uint) {
	var bitOffset uint
	//
