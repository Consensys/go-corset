...
// Shl represents an instruction of the following form:
//
// t := v << a
//
// Here, t is the target register, v is the value register, and a is the shift
// amount register.
type Shl[W word.Word[W]] struct {
...
// NewShl constructs a new bitwise left-shift instruction.
func NewShl[W word.Word[W]](target register.Id, value register.Id, amount register.Id) *Shl[W] {
	return &Shl[W]{target, value, amount}
}

// Uses implementation for Instruction interface.
func (p *Shl[W]) Uses() []register.Id {
	return []register.Id{p.Value, p.Amount}
}

// Definitions implementation for Instruction interface.
func (p *Shl[W]) Definitions() []register.Id {
	return []register.Id{p.Target}
}

// String implementation for Instruction interface.
func (p *Shl[W]) String(mapping register.Map) string {
...
func (p *Shl[W]) MicroValidate(_ uint, field field.Config, env register.Map) []error {
	return nil
}
