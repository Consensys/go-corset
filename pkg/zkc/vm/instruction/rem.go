...
// Rem represents an instruction of the following form:
//
// t := d % r
//
...
// NewRem constructs a new remainder instruction.
func NewRem[W word.Word[W]](target register.Id, dividend register.Id, divisor register.Id) *Rem[W] {
	return &Rem[W]{target, dividend, divisor}
}

// Uses implementation for Instruction interface.
func (p *Rem[W]) Uses() []register.Id {
	return []register.Id{p.Dividend, p.Divisor}
}

// Definitions implementation for Instruction interface.
func (p *Rem[W]) Definitions() []register.Id {
	return []register.Id{p.Target}
}

// String implementation for Instruction interface.
func (p *Rem[W]) String(mapping register.Map) string {
...
func (p *Rem[W]) MicroValidate(_ uint, field field.Config, env register.Map) []error {
	return nil
}
