...
func (p *Sub) MicroExecute(state []big.Int, regs []io.Register) (uint, uint) {
	var value big.Int
	// Clone initial value
...
func (p *Sub) String(regs []io.Register) string {
...
func (p *Sub) Validate(fieldWidth uint, regs []io.Register) error {
	var (
