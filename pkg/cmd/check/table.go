...
func NewTraceWindow[F field.Element[F]](cells CellRefSet, trace tr.Trace[F], padding uint, srcmap *corset.SourceMap,
) TraceWindow {
...
func determineSourceColumns[F field.Element[F]](cells CellRefSet, trace tr.Trace[F], srcmap *corset.SourceMap,
) []SourceColumn {
	var (
...
func determineSourceColumnsFromTrace[F any](cells CellRefSet, trace tr.Trace[F]) []SourceColumn {
	var (
...
func determineEnclosingModule[F any](cells CellRefSet, trace tr.Trace[F], root corset.SourceModule,
) corset.SourceModule {
	var name string
...
func isActiveColumn[F field.Element[F]](row int, col SourceColumn, trace tr.Trace[F]) bool {
...
func determineWindowBounds[F any](cells CellRefSet, trace tr.Trace[F], padding uint) (uint, uint) {
	var (
...
func determineWindowData[F field.Element[F]](start, end uint, columns []SourceColumn, trace tr.Trace[F]) [][]string {
